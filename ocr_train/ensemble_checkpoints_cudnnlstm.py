...
modelPaths = [
'weights_chn_eng_eroded_final_resnet-01-5.03.h5',
'weights_chn_eng_eroded_final_resnet-02-2.53.h5'
]
...
for modelPath in modelPaths:
	weights_list.append(load_model_weights("./tmp_models/" + modelPath) )
